...
import com.goit.javaonline.module6.part2.Guitar;
import com.goit.javaonline.module6.part2.*;
...
public class MusicStore {
    ...
    // Решение: виделить enum в котором будут допустимые названия инструментов:
    // guitar, piano, trumpet. И везде, где они встречаются по тексту заменить
    // строковые константы на константы из enum.
    public void GenerateWarehouse(){
        for (int i = 0; i < 10; i++) {
            switch (i % 3){
                case 0: warehouse.add(new com.goit.javaonline.module6.part2.Guitar("guitar"));
                    break;
